...
extract_protein_activity(
                prot_file = "Prot_patients/Prot_Patient_X01OV007.xlsx",                       
                trans_file = "Transc_patients/Transc_Patient_X01OV007.xlsx",                  
                phospho_file = "Phospho_patients/Phospho_Patient_X01OV007.xlsx", 
                tf_params,
                kin_params,
...
mutations_df <- readr::read_delim('./PatientProfiler_raw_input/mutations.csv',delim = ',')
...
create_cohort_networks(trans_dir = './Trans_test/',
                      ...
                      act_dir = './Act_test/',
                      mut_file = './PatientProfiler_raw_input/mutations.csv',
                      output_dir = './Networks_output/',
                      desired_phenotypes = c('APOPTOSIS', 'PROLIFERATION'),
