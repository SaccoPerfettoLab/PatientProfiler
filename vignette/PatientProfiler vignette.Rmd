...
```{r chunk2, eval = FALSE}
transcriptomics_data <- read_csv("./PatientProfiler_raw_input/Brca_transc.csv") 
proteomics_data <- read_csv("./PatientProfiler_raw_input/Brca_prot.csv") 
phosphoproteomics_data <- read_csv("./PatientProfiler_raw_input/Brca_phospho.csv")  
...
tr_updated <- read_csv("PatientProfiler_processed_input/Transcriptomics_updated.csv")
pr_updated <- read_csv("PatientProfiler_processed_input/Proteomics_updated.csv")
ph_updated <- read_csv("PatientProfiler_processed_input/Phosphoproteomics_updated.csv")
...
the column indicates the subtype. ou need to place this file in a
